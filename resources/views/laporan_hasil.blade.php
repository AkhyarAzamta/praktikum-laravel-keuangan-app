                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="kategori">
                                        ...
                                        @foreach($kategori as $k)
                                            <option value="{{ $k->id }}" {{ isset($id) && $k->id == $id ? 'selected' : '' }}>{{ $k->kategori }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                    ...
                    <table class="table table-bordered mt-4">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td class="text-center bg-success text-white font-weight-bold">{{ "Rp." . number_format($total_pengeluaran) . ",-" }}</td>
                            </tr>
                        </tfoot>
                    </table>
                </div>
